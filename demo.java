...
public class demo extends JFrame {
    ...
    * Helper function for view/edit inventory screen that updates the inventory
    ...
    public static void manager_view() {
        ...
        salesReportInput.setBounds(200, 200, 300, 100);
    ...
    public static void sales_report_input() {
        ...
        JLabel dateLabel1 = new JLabel("Enter the starting date: (mm-dd-yyy)");
        JTextField month1 = new JTextField("mm");
        JTextField day1 = new JTextField("dd");
        JTextField year1 = new JTextField("yyy");

        JLabel dateLabel2 = new JLabel("Enter the ending date: (mm-dd-yyyy)");
        JTextField month2 = new JTextField("mm");
        JTextField day2 = new JTextField("dd");
        JTextField year2 = new JTextField("yyy");
